...
import { Box, Typography, Grid, Paper, Card, CardContent, CircularProgress, Alert, FormControl, InputLabel, Select, MenuItem, TextField } from '@mui/material';
      ...
      <Grid container spacing={3} className={styles.section}>
        ...
        <Grid item xs={12} md={4}>
          <Paper className={styles.paper}>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie data={materialUsage} cx="50%" cy="50%" outerRadius={80} dataKey="value" label={({ name, value }) => `${name}: ${value}` }>
